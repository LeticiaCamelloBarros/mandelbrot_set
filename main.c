...
int main(int argc, char *argv[]) {
    ...
    validar_num_threads(num_threads);  // <-- checagem, antes de qualquer uso
    ...
    /* -------------------------- Pthreads 1 ---------------------------- */
    /* Estratégia de divisão do trabalho: INTERCALADA/CÍCLICA por linha.  */
    ...
    /* -------------------------- Pthreads 2 ---------------------------- */
    /* Estratégia de divisão do trabalho: BLOCOS CONTÍGUOS de linhas.     */
